...
// par defaut du rafraichissement de la carte /etat: un depart a 06:00 et un
...
// buildStatusData assemble la page /etat a partir de la configuration courante
